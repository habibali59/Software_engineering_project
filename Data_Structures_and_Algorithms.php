...
$sql = "SELECT * FROM meterals JOIN complete ON meterals.id=complete.id JOIN users ON complete.id=users.id  join quiz ON quiz.meteral=users.id WHERE email='$user_email' and meterals.name='Data_Structures_and_Algorithms'";
...
<body>
    <div class="container">
        ...
        <div class="class-details">
            ...
            <p><strong>Instructor:</strong> Maiss saad</p>
